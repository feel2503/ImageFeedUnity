...
public class CropperGridView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mColor = mTypedArray.getColor(R.styleable.crop__CropperView_crop__grid_color, mColor);

            float alpha = 255 * mTypedArray.getFloat(R.styleable.crop__CropperView_crop__grid_opacity, 1f);
            if (alpha < 0) {
                alpha = 0;
            } else if (alpha > 255) {
                alpha = 255;
            ...
            mStrokeWidth = mTypedArray.getDimensionPixelOffset(R.styleable.crop__CropperView_crop__grid_thickness,
                    mStrokeWidth);
